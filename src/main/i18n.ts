...
const TRANSLATIONS: Record<AppLanguage, Record<string, string>> = {
    en: {
        ...
        "conversation.stt.audioOff": "STT idle: microphone off",
        "conversation.stt.disabled": "STT paused",
        "conversation.stt.ready": "STT ready",
        "conversation.stt.starting": "STT starting...",
        "conversation.stt.listening": "STT listening",
        "conversation.stt.transcribing": "STT transcribing...",
        "conversation.stt.error": "STT unavailable",
        ...
        "status.stt.on": "Speech On",
        "status.stt.off": "Speech Off",
    ...
    zh: {
        ...
        "conversation.stt.audioOff": "语音识别待机中：麦克风已关闭",
        "conversation.stt.disabled": "语音识别已暂停",
        "conversation.stt.ready": "语音识别已就绪",
        "conversation.stt.starting": "语音识别启动中...",
        "conversation.stt.listening": "语音识别监听中",
        "conversation.stt.transcribing": "语音识别转写中...",
        "conversation.stt.error": "语音识别不可用",
